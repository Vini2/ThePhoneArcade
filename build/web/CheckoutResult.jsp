<%-- 
    ...
    Created on : Dec 5, 2013, 6:55:08 PM
    Author     : Asus
--%>
            ...
            <table width="1000" height="1000" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="5"  height="100">
                        <div class="content" style="padding-left: 20px; padding-right: 20px;">
                            ...
                            %>
                            <h2><img src="images/checkout-dark1.png" height="50px" width="auto"/>&nbsp;&nbsp;&nbsp;Payment successfully processed</h2>
                            <hr><br>
                            Your payment was successfully processed.
                            <br><br>
                            Follow this link to view the <a href="OrderDetails.jsp?inid=<%=request.getParameter("inid")%>" class="alink">Order Details</a>
                            
                            
                            <%}
                                    else if (request.getParameter("msg").equals("Error")) {
                            %>
                            <h2><img src="images/failed.jpg" height="50px" width="auto"/>&nbsp;&nbsp;&nbsp;Payment process failed</h2>
                            <hr><br>
                ...
                <tr>
                    <td colspan="5" align="center">
                        <br><br><br><br>
                        <img src="images/best-mobile-phones.jpg" width="900px" height="auto"/><br><br><br><br>
                    </td>
                </tr>
                <tr>

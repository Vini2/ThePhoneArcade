<%-- 
    Document   : Nokia
    Created on : Oct 23, 2013, 6:12:57 PM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - Nokia</title>
            ...
            <table width="1000" height="1500" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="3" height="375">
                        ...
                        <div id='slideshowHolder'>
                            <img src='SlideShows/Nokia/1.jpg' alt='Nokia Asha 311' />
                            <img src='SlideShows/Nokia/2.jpg' alt='Nokia Lumia 1020' />
                            <img src='SlideShows/Nokia/3.jpg' alt='Nokia Lumia 620' />
                            <img src='SlideShows/Nokia/4.jpg' alt='Nokia Asha 501' />
                            <img src='SlideShows/Nokia/5.jpg' alt='Nokia Lumia 820' />
                            <img src='SlideShows/Nokia/6.jpg' alt='Nokia Lumia 925' />
                        </div>
                    ...
                    <td colspan="2">
                        <img src="Logos/Nokia logo.png"/><br><br>
                        <div class="content">
                            Eye catching Nokia Windows phones are available free on our mobile phone 
                            contract deals across the major phone networks. Access over 150,000 of the 
                            latest Windows Phone apps.<br><br>
                            Choose from the popular Nokia Lumia series, such as the best-selling Nokia 
                            Lumia 920 with its wireless charging features or the Nokia 610. Discover the 
                            latest Nokia Windows Phones for a great smartphone experience.<br><br>
                            Nokia Lumia phones include built-in HERE Maps, and also stream music free with 
                            Nokia Music. Get your Nokia phone free today with one of our great deals.<br><br>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" height="200">
                        ...
                        <%
                            ...
                            c1.add(Restrictions.eq("makeName", "Nokia"));
                ...
                <tr>
                    <td colspan="8" align="center">
                        ...
                        <% if (index > 0) {%>
                        <a href="Nokia.jsp?index=<%= index - 12%>">

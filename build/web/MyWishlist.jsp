<%-- 
    Document   : MyWishlist
    Created on : Oct 28, 2013, 10:53:30 AM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - My Wishlist</title>
    ...
    <center>
        <div id="tab">
            <table width="1000" height="2000" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="5" height="5"><div class="content"><br><a href="Home.jsp" class="alink">Home</a> > My Wishlist<br></div></td>
                </tr>
                <tr>
                    <td colspan="5" height="40" align="center">
                        <h2 style="text-shadow: 5px 5px 5px #999999;">My Wishlist</h2><br><br>
                    </td>
                </tr>
                        ...
                        <div class="wishlist">
                            <table width="800" align="center" cellpadding="10px" border="0">
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <div class="content">
                                            ...
                                            <img src="images/wishliste.png" width="250px" height="auto"/>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="DeleteFromWishlistServlet?pcid=<%=pc.getPcId()%>"><input type="button" value="REMOVE" class="button-search" /></a>
                                    </td>

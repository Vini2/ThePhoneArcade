 ...
 * @author Asus
 */
@WebServlet(name = "AdminUpdateProductDetails", urlPatterns = {"/AdminUpdateProductDetails"})
public class AdminUpdateProductDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("Admin-UpdateProductDetails.jsp");

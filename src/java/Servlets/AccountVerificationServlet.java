 ...
 * @author Asus
 */
@WebServlet(name = "AccountVerificationServlet", urlPatterns = {"/AccountVerificationServlet"})
public class AccountVerificationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String email = new SecurityEncDec().decrypt(request.getParameter("ea"));
            ...
            response.sendRedirect("AccountVerification.jsp?msg=" + msg);

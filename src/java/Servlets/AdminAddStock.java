 ...
 * @author Asus
 */
@WebServlet(name = "AdminAddStock", urlPatterns = {"/AdminAddStock"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (NumberCheck.isNumeric(qty)) {
                ...
                Stock st = new Stock();
                st.setProduct(p);
                st.setQty(Double.parseDouble(qty));
                st.setDate(new Date());
                ...
                response.sendRedirect("Admin-AddStock.jsp?msg=Stock added successfully&make="+make+"&index="+index);
                
            } else {
                response.sendRedirect("Admin-AddStock.jsp?msg=Please enter a valid quantity&make="+make+"&index="+index);
            }

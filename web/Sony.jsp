<%-- 
    Document   : Sony
    Created on : Oct 23, 2013, 6:19:39 PM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - Sony</title>
            ...
            <table width="1000" height="1500" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="3" height="375">
                        ...
                        <div id='slideshowHolder'>
                            <img src='SlideShows/Sony/1.jpg' alt='Sony Xperia M dual' />
                            <img src='SlideShows/Sony/2.jpg' alt='Sony Xperia Tablet S' />
                            <img src='SlideShows/Sony/3.jpg' alt='Sony Xperia Z1' />
                            <img src='SlideShows/Sony/4.jpg' alt='Sony Xperia Tablet Z' />
                            <img src='SlideShows/Sony/5.jpg' alt='Sony Xperia ZL' />
                        </div>
                    ...
                    <td colspan="2">
                        <img src="Logos/Sony logo.jpg"/><br><br>
                        <div class="content">
                            Sony phones are slick and packed with competitive features. 
                            Check out the best-selling and water proof Sony Xperia Z phone. 
                            Also access over 700,000 of the latest Android apps.<br><br>
                            Sony Xperia™ mobile phones run on the latest Android operating system. 
                            Featuring a super-fast processor and Sony Bravia technology images are clearer 
                            and razor sharp for the HD screen display.<br><br>
                            Choose from the latest Sony mobiles including the Xperia™ S and Xperia™ T 
                            models. Find great Sony phone deals on all the mobile networks.<br><br>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" height="200">
                        ...
                        <div class="content"><h2>Products Available</h2><hr></div>
                            <%
                                ...
                                c1.add(Restrictions.eq("makeName", "Sony"));
                ...
                <tr>
                    <td colspan="8" align="center">
                        ...
                        <% if (index > 0) {%>
                        <a href="Sony.jsp?index=<%= index - 12%>">

<%-- 
    Document   : Admin-DeleteProduct
    Created on : Nov 4, 2013, 2:36:19 PM
    Author     : Asus
--%>
...
<html>
    ...
    <center>
        ...
        <div class="content">
            ...
            <form method="POST" action="Admin-DeleteProduct.jsp" onsubmit="validate(this)" id="testform">
    ...
    <div class="details">
        <table border="0" align="center">
            ...
            <tr>
                ...
                <td width="150" align="center"><a href="AdminDeleteProduct?pid=<%=p.getIdproduct()%>&make=<%=request.getParameter("make")%>&index=<%=index%>">
                        <input type="submit" value="REMOVE" class="button1" style="width: 100px"/>
                        </a></td>
            ...
            <tr><td colspan="7" align="center">
                    ...
                    <% if (index > 0) {%>
                    <a href="Admin-DeleteProduct.jsp?index=<%= index - 10%>&make=<%=request.getParameter("make")%>">

<%-- 
    ...
    Created on : Oct 30, 2013, 7:47:40 PM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - Accessories</title>
            ...
            <table width="1000" height="2000" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="5" height="100">
                        ...
                        <%
                            ...
                            if (request.getParameter("type").equals("Charger")) {
                                type = "Charger";
                            } else if (request.getParameter("type").equals("Battery")) {
                                type = "Battery";
                            } else if (request.getParameter("type").equals("Cover")) {
                                type = "Cover";
                            } else if (request.getParameter("type").equals("ScreenGuard")) {
                                type = "Screen Guard";
                            } else if (request.getParameter("type").equals("Headset")) {
                                type = "Headset";
                            } else if (request.getParameter("type").equals("Other")) {
                                type = "Other Accessories";
                            }
                        %>

                        <div class="content"><h2>Accessories - <%=type%></h2><hr></div>
                        ...
                        <%
                            ...
                            Criteria c21 = s.createCriteria(Category.class);
                            c21.add(Restrictions.eq("categoryName", "Tablet"));
                            Category cat2 = (Category) c21.uniqueResult();

                            Criteria c4 = s.createCriteria(Product.class);
                            c4.add(Restrictions.eq("status", "Available"));
                            c4.add(Restrictions.not(Restrictions.eq("category", cat1)));
                            c4.add(Restrictions.not(Restrictions.eq("category", cat2)));

                            if (type.equals("Other Accessories")) {
                                c4.add(Restrictions.not(Restrictions.like("name", "%Charger%")));
                                c4.add(Restrictions.not(Restrictions.like("name", "%Battery%")));
                                c4.add(Restrictions.not(Restrictions.like("name", "%Cover%")));
                                c4.add(Restrictions.not(Restrictions.like("name", "%Screen Guard%")));
                                c4.add(Restrictions.not(Restrictions.like("name", "%Headset%")));
                            } else {
                                c4.add(Restrictions.like("name", "%" + type + "%"));

                            }
                            c4.addOrder(Order.asc("make"));
                            ...
                            <table width="200" height="300" border="0" align="center">
                                ...
                                <tr>
                                    <td align="center" height="40">
                                        ...
                                        <%if (p.getMake().getMakeName().equals("Other")) {
                                        %>
                                        <%=p.getName()%>
                                        <%} else {%>
                                        <%=p.getMake().getMakeName() + " " + p.getName()%>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <a href="ViewDetailsAccessory.jsp?pid=<%=p.getIdproduct()%>"><input type="submit" value="VIEW" class="button-search" style="width: 100px"/></a>
                                            <%} else {%>
                ...
                <tr>
                    <td colspan="8" align="center">
                        ...
                        <% if (index > 0) {%>
                        <a href="Accessories.jsp?index=<%= index - 16%>&type=<%=type%>">

<%-- 
    Document   : E-tel
    Created on : Oct 27, 2013, 10:37:28 PM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - E-tel</title>
            ...
            <table width="1000" height="1500" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="3" height="375">
                        ...
                        <div id='slideshowHolder'>
                            <img src='SlideShows/E-tel/1.png' alt='E-tel T11' />
                            <img src='SlideShows/E-tel/2.png' alt='E-tel T15' />
                            <img src='SlideShows/E-tel/3.png' alt='E-tel i3' />
                            <img src='SlideShows/E-tel/4.png' alt='E-tel T18' />
                            <img src='SlideShows/E-tel/5.png' alt='E-tel V2' />
                        </div>
                    ...
                    <td colspan="2">
                        <img src="Logos/E-tel logo.png"/><br><br>
                        <div class="content">
                            Brantel Lanka Private Limited was established in 2004 with a vision to be a 
                            customer focused, market led conglomerate that provides cutting-edge 
                            communication solutions coupled with superior customer support to a wide 
                            range of customers.  Brantel builds its business by sharing knowledge and 
                            expertise with strategic business partners in order to achieve sustained rapid 
                            growth. It acknowledges that business ethics and accountability of the 
                            organization in all levels enhances its reputation and build confidence 
                            amongst its stake holders.<br><br>
                            E-tel corporation Lanka (Pvt) Limited is a subsidiary of Brantel Lanka (Pvt) 
                            Limited and the official owner of E-tel Brand in Sri Lanka.
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" height="200">
                        ...
                        <%
                            ...
                            c1.add(Restrictions.eq("makeName", "E-tel"));
                ...
                <tr>
                    <td colspan="8" align="center">
                        ...
                        <% if (index > 0) {%>
                        <a href="E-tel.jsp?index=<%= index - 12%>">

<%-- 
    Document   : AboutUs
    Created on : Dec 1, 2013, 1:45:53 PM
    Author     : Asus
--%>
    ...
    <center>
        <div id="tab">
            <table width="1000" height="1000" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="5">
                <center><h2 style="text-shadow: 5px 5px 5px #999999;">About Us</h2></center><br>

                </td>
                </tr>
                <tr>
                    <td colspan="5" height="200" align="center">
                        <script type="text/javascript" src="photos/js/swfobject.js"></script>
                        <script type="text/javascript" src="photos/js/flashgallery.js"></script>
                        <script type="text/javascript">
                            jQuery.flashgallery('photos/photos.swf', 'photos/config.xml', {width: '900px', height: '520px', background: 'transparent'});
                        </script>
                        <br><br><br><br>
                    </td>
                </tr>
                <tr>
                    <td colspan="5">
                        <div class="branch content">
                            <h2>&nbsp;&nbsp;About The Phone Arcade</h2>
                            <div style="padding-left: 10px; padding-right: 10px">
                                <p align="justify" class="content">We, The Phone Arcade, are a company established as a highly distinguished and recognized supplier in the cellular communications industry. Our goal to become the leading distributor of wireless communications services through out the City of Kalutara has now become a reality.</p>
                            </div>
                            <div style="padding-left: 10px; padding-right: 10px">
                                <p align="justify" class="content">With fully equipped showrooms in in Kalutara, The Phone Arcade has identified the emerging trends and built them into our company’s operations. Our capacity to respond fast to technology changes and being there on time, providing high-quality customer services, investing in the right resources, expanding into specialty markets, and staying ahead of the "technology curve" has been the keys to our success.</p>
                            </div>
                            <div style="padding-left: 10px; padding-right: 10px">
                                <p align="justify" class="content">The company was initially formed as a sole proprietorship by Mr. Ishara Gunatilake, in May 2007 in Kaluatar. From there on we have succeeded tremendously. Taking advantage on the growing wireless communications industry and based on our success in the first showroom, we decided to expand our company's operations to two more showrooms in Kalutara and another showroom in Mathugama.</p>
                            </div>
                            <div style="padding-left: 10px; padding-right: 10px">
                                <p align="justify" class="content">We directly import our stocks from authorized distributors from all over the world, thereby providing our loyal and satisfied customers with genuine and authentic products. Also, we are the authorized distributor of Samsung mobile phones for Kalutara region.</p>
                            </div>
                            <div style="padding-left: 10px; padding-right: 10px">
                                <p align="justify" class="content">Our product range covers all types and models of cellular phones, smart phones, personal digital assistants (PDA), tablet computers, authorized software applications for all cellular products and accessories of all types and reputed brands.</p>
                            </div>
                ...
                <tr>
                    <td colspan="5" height="170px" align="center">

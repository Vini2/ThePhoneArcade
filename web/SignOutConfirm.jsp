<%-- 
    Document   : SignOutConfirm
    Created on : Dec 4, 2013, 7:25:00 PM
    Author     : Asus
--%>
                ...
                <tr>
                    <td colspan="5"  height="50">
                        <div class="content" style="padding-left: 20px; padding-right: 20px;">
                            <h2><img src="images/tick.jpg" height="50px" width="auto"/>&nbsp;&nbsp;&nbsp;You've signed out</h2>
                            <hr><br>
                            You've signed out successfully. See you again soon!
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" align="center">
                        <br><br><br><br>
                        <img src="images/Mobile-tablets-device-battle-android-iphone-lumia.JPG" width="900px" height="auto"/><br><br><br><br>
                    </td>
                </tr>
                <tr>

<%-- 
    Document   : LG
    Created on : Oct 23, 2013, 6:18:56 PM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - LG</title>
                ...
                <tr>
                    <td colspan="3" height="375">
                        ...
                        <div id='slideshowHolder'>
                            <img src='SlideShows/LG/1.jpg' alt='LG G2' />
                            <img src='SlideShows/LG/2.jpg' alt='LG Optimus F6' />
                            <img src='SlideShows/LG/3.jpg' alt='LG Optimus F7' />
                            <img src='SlideShows/LG/4.jpg' alt='LG Fluid' />
                            <img src='SlideShows/LG/5.jpg' alt='LG Rumor Reflex LN272' />
                        </div>
                    ...
                    <td colspan="2">
                        ...
                        <div class="content">
                            <img src="Logos/LG logo.jpg"/><br><br>
                            The latest new handsets from LG, such as the LG Nexus 4 and the LG Optimus 4XHD, 
                            are packed with incredible features, to ensure that you get a fantastic smartphone 
                            experience.<br><br>
                            Running on the Android operating system, these LG mobile phones are slim, compact 
                            and easy-to-use. Fantastic viewing capabilities, and a whole host of the latest technology, 
                            ensures that you get the best out of your device.<br><br><br><br><br><br>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" height="200">
                        ...
                        <div class="content"><h2>Products Available</h2><hr></div>
                            <%
                                ...
                                c1.add(Restrictions.eq("makeName", "LG"));

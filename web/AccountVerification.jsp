<%-- 
    ...
    Created on : Nov 28, 2013, 10:51:44 AM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - Account Verification</title>
                ...
                <tr>
                    <td colspan="5"  height="100">
                        <div class="content">
                            ...
                            <hr><br>
                            Your account was successfully verified. <br><br>
                            Please sign in to access your TPA account
                            
                            <div class="button-wrapper content">
                                <br>
                                <a href="SignIn.jsp" class="a-btn">
                                    <span class="a-btn-text">SIGN IN</span> 
                                    <span class="a-btn-slide-text">Enjoy!</span>
                            ...
                            <h2>Error</h2>
                            <hr><br>
                            An unexpected error occurred while attempting to activate your account. Make sure you have signed up and try again.
                            <%} else if (request.getParameter("msg").equals("Error2")) {%>
                            <h2>Error</h2>
                            <hr><br>
                            An unexpected error occurred while attempting to activate your account. Make sure you have browsed the correct link and try again.
                            <%}else if (request.getParameter("msg").equals("Error3")) {%>
                            <h2>Link Expired</h2>
                            <hr><br>
                            The link you have browsed has expired.
                            <%}%>
                        </div>

<%-- 
    Document   : MobileDevicesOther
    Created on : Nov 4, 2013, 10:23:37 PM
    Author     : Asus
--%>
...
<html>
    <head>
        ...
        <title>The Phone Arcade - Other</title>
            ...
            <table width="1000" height="1500" border="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="5" height="100">
                        <div class="content"><h2>Other Products Available</h2><hr></div>
                            <%
                                ...
                                Criteria c31 = s.createCriteria(Make.class);
                                c31.add(Restrictions.eq("makeName", "Samsung"));
                                Make m1 = (Make) c31.uniqueResult();

                                Criteria c32 = s.createCriteria(Make.class);
                                c32.add(Restrictions.eq("makeName", "Nokia"));
                                Make m2 = (Make) c32.uniqueResult();

                                Criteria c33 = s.createCriteria(Make.class);
                                c33.add(Restrictions.eq("makeName", "Sony"));
                                Make m3 = (Make) c33.uniqueResult();

                                Criteria c34 = s.createCriteria(Make.class);
                                c34.add(Restrictions.eq("makeName", "LG"));
                                Make m4 = (Make) c34.uniqueResult();

                                Criteria c35 = s.createCriteria(Make.class);
                                c35.add(Restrictions.eq("makeName", "Micromax"));
                                Make m5 = (Make) c35.uniqueResult();

                                Criteria c36 = s.createCriteria(Make.class);
                                c36.add(Restrictions.eq("makeName", "E-tel"));
                                Make m6 = (Make) c36.uniqueResult();
                                ...
                                c4.add(Restrictions.not(Restrictions.eq("make", m1)));
                                c4.add(Restrictions.not(Restrictions.eq("make", m2)));
                                c4.add(Restrictions.not(Restrictions.eq("make", m3)));
                                c4.add(Restrictions.not(Restrictions.eq("make", m4)));
                                c4.add(Restrictions.not(Restrictions.eq("make", m5)));
                                c4.add(Restrictions.not(Restrictions.eq("make", m6)));
                            ...
                            <table width="200" height="300" border="0" align="center">
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <a href="ViewDetailsAccessory.jsp?pid=<%=p.getIdproduct()%>"><input type="submit" value="VIEW" class="button-search"/></a>
                                            <%} else {%>
                                        <a href="ViewDetails.jsp?pid=<%=p.getIdproduct()%>"><input type="submit" value="VIEW" class="button-search"/></a>
                                            <%}%>
                                    </td>
                                </tr>
                ...
                <tr>
                    <td colspan="8" align="center">
                        ...
                        <% if (index > 0) {%>
                        <a href="MobileDevicesOther.jsp?index=<%= index - 12%>">
